...
class BookComponent extends Component {
  constructor(props) {
    ...
    console.log(
      'BookComponent: creating initial state of book with "none" state.'
    );
    this.state = {
      id: this.props.id,
      title: '',
  ...
  componentDidMount() {
    ...
    console.log(
      'BookComponent did mount, state was set based on get(book), for each book.'
    );
  }
  ...
  handleChange(event) {
    ...
    BooksAPI.update({ id: this.state.id }, newShelf)
